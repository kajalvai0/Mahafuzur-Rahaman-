...
import { Home, User, LogIn, LogOut, Shield, ChevronRight, X, Heart, Scale } from "lucide-react"
import { AppView, type User as UserType } from "../types"
...
export const SideMenu: React.FC<SideMenuProps> = ({
  ...
  return (
    <>
      ...
      {/* Menu Panel */}
      <div
        className={`fixed top-0 left-0 h-full w-80 bg-white z-[70] shadow-2xl transition-transform duration-300 ease-out transform ${isOpen ? "translate-x-0" : "-translate-x-full"}`}
      >
        <div className="flex flex-col h-full">
          ...
          <div className="election-gradient p-8 text-white relative">
            ...
            <div className="flex items-center gap-2">
              ...
              <Scale size={18} className="text-emerald-200 shrink-0" />
            </div>
