      ...
      <div className="space-y-4">
        ...
        <div className="p-4 bg-red-50 border border-red-100 rounded-2xl flex items-start gap-3">
           ...
           <div>
              ...
              <p className="text-[10px] text-red-600 leading-relaxed">অ্যাডমিন প্যানেলের পরিবর্তনগুলো সরাসরি ভোটারদের অ্যাপে প্রভাব ফেলবে। সঠিক তথ্য নিশ্চিত করে আপডেট করুন।</p>
           </div>
        </div>
      </div>
    </div>
